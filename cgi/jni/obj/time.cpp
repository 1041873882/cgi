...
printf("        var h = String(d.getHours());\n");
printf("        var m = String(d.getMinutes());\n");
printf("        var s = String(d.getSeconds());\n");
printf("        document.getElementById(\"text\").value = h+\":\"+m+\":\"+s;\n");
printf("    }\n");
printf("</script>\n");
printf("\n");
printf("\n");
...
printf("                    <td>\n");
printf("                    <input  type=\"text\" style=\"width:160px;\" name=\"hour\" value=\"");
 ePrint(p.getText("/params/settime/hour")); printf("\", id=\"text\"></td>\n");
printf("                    <td>\n");
printf("                    <input type=\"button\" value=\"");
 ePrint(ehttp_xml.get("/dnake/sync_time")); printf("\" onClick=\"on_sync_button()\"></td>\n");
printf("                </tr>\n");
printf("                <tr>\n");
printf("                    <td>&nbsp;</td>\n");
printf("                    <td>&nbsp;</td>\n");
