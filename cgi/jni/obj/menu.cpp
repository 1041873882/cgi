...
printf("</tr>\n");
printf("<tr class=\"menu\" onMouseOver=\"this.style.background=\'Coral url(/images/button_bg_over.gif)  no-repeat top center\'\" onMouseOut=\"tabOut(this , \'#99cc33\',\'\')\">\n");
printf("	<td class=\"menu\"><a href=\"/cgi-bin/capture.cgi\" target=\"main\">");
 ePrint(ehttp_xml.get("/dnake/menu/capture")); printf("</a></td>\n");
printf("</tr>\n");
printf("<tr>\n");
printf("	<td><img src=\"/images/SystemUI_08.jpg\" width=\"163\" height=\"2\" alt=\"\"></td>\n");
printf("</tr>\n");
printf("<tr class=\"menu\" onMouseOver=\"this.style.background=\'Coral url(/images/button_bg_over.gif)  no-repeat top center\'\" onMouseOut=\"tabOut(this , \'#99cc33\',\'\')\">\n");
printf("	<td class=\"menu\"><a href=\"/cgi-bin/calllogs.cgi\" target=\"main\">");
 ePrint(ehttp_xml.get("/dnake/menu/calllogs")); printf("</a></td>\n");
printf("</tr>\n");
printf("\n");
printf("\n");
